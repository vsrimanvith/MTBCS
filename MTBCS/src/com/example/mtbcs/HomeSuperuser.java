...
public class HomeSuperuser extends Activity {
	Button ab,bs,pr,log;
	TextView aaa;
	SQLiteDatabase db;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_home_superuser);
		...
		ab.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startActivity(new Intent(getApplicationContext(),Saddproject.class));
			}
		});
bs.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				startActivity(new Intent(getApplicationContext(),Sbugview.class));
			}
		});
...
pr.setOnClickListener(new OnClickListener() {
	...
	public void onClick(View v) {
		// TODO Auto-generated method stub
		Cursor c=db.rawQuery("SELECT * FROM sreg WHERE id='"+aaa.getText()+"'", null);
		if(c.getCount()==0)
		{
